...
START TRANSACTION;
USE `Iuteb_asignaturas`;
INSERT INTO `Iuteb_asignaturas`.`usuarios` (`id_usuario`, `usuario`, `contrasena`, `nombre_completo`, `cedula`, `correo`, `fecha_ingreso`, `telefono`, `foto_perfil`, `id_malla`, `estado`, `tipo`, `color_ui`) VALUES (1, 'Administrador', 'SoporteGATE', 'Administrador', 000000000, 'iutebgate@gmail.com', '19-11-2017', 04128594981, 'grabatar.jpg', 1, '1', 'Administrador', NULL);
