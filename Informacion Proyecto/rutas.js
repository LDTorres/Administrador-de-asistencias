...
$http.post('/usuario/modificar');
$http.get('/usuario/configuracion');
...
$http.post('/pnf/modificar'); /* Modificar un nuevo PNF */
...
$http.get('/seccion/alumnos');
$http.post('/seccion/nuevoAlumno');
