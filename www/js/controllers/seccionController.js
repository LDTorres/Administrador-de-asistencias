angular.module('GATE').controller('seccionController', ['$scope', '$stateParams', 'servicioSecciones', 'ionicDatePicker', '$state', '$rootScope', function ($scope, $stateParams, servicioSecciones, ionicDatePicker, $state, $rootScope) {
  var bz = this;
